...
router.get('/painel/admin', Autenticar.authAdm, Metodos.painelAdm);
...
router.get('/user/edit/:id', Autenticar.authUser, Metodos.pag_edit_user);
router.post('/user/editar', Metodos.editUser);
router.get('/alugar/moto/:id', Autenticar.authAdm, Metodos.pagAlugarMoto);
...
router.get('/moto/editar/:id', Metodos.pagEditarMoto);
router.post('/moto/editar', Metodos.editarMoto);
...
router.get('/pag/lucro', Autenticar.authAdm, Metodos.pagTotalLucro);
router.get('/pag/motos/user', Autenticar.authUser, Metodos.motosUser);
